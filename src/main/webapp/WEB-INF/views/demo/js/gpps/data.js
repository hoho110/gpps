var createProductLine = function(title, label1, des1, label2, des2, description, menkan, qixian, rate, style){
	var container = $('<div></div>').addClass('newProject0Item').addClass('newProjectInfoBox');
	...
	stateBtnDiv.html('<p class="stateBtnProcess"><span class="stateText">'+title+'</span></p>');
	...
	row2_col1.html('<div class="seemall"><a href="projectlist.html"></a></div>');
