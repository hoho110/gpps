...
public class CreateMain {
	...
	public static void main(String args[]){
		...
		long istart1 = (new Date(2014-1900, 10, 3)).getTime();
		long fstart1 = (new Date(2014-1900, 10, 1, 8, 0, 0)).getTime();
		long fend1 = (new Date(2014-1900, 10, 2, 18, 0, 0)).getTime();
		...
		long istart2 = (new Date(2014-1900, 10, 6)).getTime();
		long fstart2 = (new Date(2014-1900, 10, 3, 8, 0, 0)).getTime();
		long fend2 = (new Date(2014-1900, 10, 5, 18, 0, 0)).getTime();
		...
		long istart3 = (new Date(2014-1900, 10, 9)).getTime();
		long fstart3 = (new Date(2014-1900, 10, 6, 8, 0, 0)).getTime();
		long fend3 = (new Date(2014-1900, 10, 8, 18, 0, 0)).getTime();
		...
		long istart4 = (new Date(2014-1900, 10, 15)).getTime();
		long fstart4 = (new Date(2014-1900, 10, 12, 8, 0, 0)).getTime();
		long fend4 = (new Date(2014-1900, 10, 14, 18, 0, 0)).getTime();
		...
		long iend11 = (new Date(2015-1900, 1, 3)).getTime();
		long iend12 = (new Date(2015-1900, 4, 3)).getTime();
		long iend13 = (new Date(2015-1900, 10, 3)).getTime();
		...
		long iend21 = (new Date(2015-1900, 1, 6)).getTime();
		long iend22 = (new Date(2015-1900, 4, 6)).getTime();
		...
		long iend32 = (new Date(2015-1900, 4, 9)).getTime();
		...
		long iend41 = (new Date(2015-1900, 4, 15)).getTime();
