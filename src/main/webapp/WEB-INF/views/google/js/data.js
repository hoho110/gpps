var createProductLine = function(cont, id, title, label1, des1, label2, des2, description, menkan, qixian, rate, style){
	...
	stateBtnDiv.html('<p class="stateBtnProcess"><a title="产品列表" class="productline" href="productlist.html?sid='+id+'" target="_blank"><span class="stateText">'+title+'&nbsp;(3)</span></a></p>');
